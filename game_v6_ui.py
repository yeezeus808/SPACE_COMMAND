...
G_CONSTANT   = 30_000    # gravitational constant (tuned for fun)
BLACK_HOLE_MASS = 0.5    # relative mass multiplier
BH_MAX_ACCEL = 2.1       # cap gravity acceleration per frame (prevents inescapable pull)
...
class Menu:
    ...
    def _draw_difficulty(self, mp):
        ...
        # Descriptions
        descs = [
            (self.btn_easy,   "AI reaction is slow and misses often"),
