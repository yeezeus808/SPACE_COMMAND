...
VERSION 5 - Black hole weakened + asteroid stuck fix + Mercury black hole fix
"""
...
class Game:
    def __init__(self):
        ...
        # Two wormhole-connected black holes, one per side poral 2 ahh physics 
        self.bh_l = BlackHole(WIDTH // 4,     HEIGHT // 2, (0, 101, 255))  # left  — blue
        self.bh_r = BlackHole(WIDTH * 3 // 4, HEIGHT // 2, (255, 93, 0))  # right — orange 
    ...
    def update(self):
        ...
        for bh in self.black_holes:
            if bh.swallowed(self.ball):
                ...
                break  # only one wormhole at a time
