...
G_CONSTANT      = 90_000   # gravitational constant (tuned for fun)
...
class Game:
    def __init__(self, screen, two_player=True, difficulty=None):
        ...
        _font        = "gamezfontz/blockyahh.ttf"
...
class Menu:
    ...
    def __init__(self, screen):
        ...
        self._build_buttons()
        self.alien_closed = pygame.image.load("spritez/Acloesed_mouth.png").convert_alpha()
        self.alien_open   = pygame.image.load("spritez/Aopen_mouth.png").convert_alpha()
