        ...
        for _ in range(3):
            for a in self.asteroids:
                ...
                if dist < min_dist and dist > 0:
                    ...
                    if punching:
                        # ── Punch through — push asteroid aside, ball keeps going ──
                        a["x"] += nx * (min_dist - dist + 4) * 2
                        a["base_y"] += ny * (min_dist - dist + 4) * 2
...
class BlackHole:
    ...
    def eject_ball(self, ball):
        ...
        exit_speed = max(15.0, math.hypot(ball.vx, ball.vy)) * BH_SPEED_REDUCTION
