...
class Game:
    def __init__(self, screen, two_player=True, difficulty=None):
        ...
        # Two black holes are conected via wormholes,so one per side 
        # Screen is 1200px wide. Belt is at centre (600px).
        # # bh_l is left hole, bh_r is right hole.
        # # To move closer to belt, increase bh_l X / decrease bh_r X.
        # # Current positions: 450px (left) and 750px (right) — each 150px from centre.
